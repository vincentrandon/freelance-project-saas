...
function InvoicePDFPreview({ formData, customer, project }) {
  ...
  return (
    <div className="sticky top-6 h-fit bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm overflow-hidden">
      {/* Header */}
      <div className="bg-gradient-to-r from-violet-50 to-purple-50 dark:from-violet-900/20 dark:to-purple-900/20 border-b border-gray-200 dark:border-gray-700 px-6 py-4">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">See how your invoice will look</p>
      </div>
      ...
      <div className="p-6 max-h-[calc(100vh-200px)] overflow-y-auto">
        ...
        <div className="mb-6 pb-6 border-b border-gray-200">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400">
            {formData.invoice_number || 'FACT-XXXX-XXXX'}
          </p>
        </div>
          ...
          <div>
            ...
            <div className="text-sm space-y-1">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900 dark:text-gray-100">{formatDate(formData.due_date)}</span>
              </div>
            </div>
          </div>
        </div>
            ...
            {formData.paid_amount > 0 && (
              <>
                ...
                <div className="flex justify-between text-base font-bold text-red-600 dark:text-red-400">
                  ...
                  <span>
                    {formatCurrency((formData.total || 0) - (formData.paid_amount || 0))}
                  </span>
                </div>
              </>
            )}
        ...
        {formData.payment_terms && (
          <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-lg">
            <p className="text-xs font-medium text-blue-900 dark:text-blue-300 mb-1">Conditions de paiement</p>
